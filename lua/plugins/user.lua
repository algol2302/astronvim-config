          ...
          keys = {
            {
              key = "n",
              action = "<Leader>n",
              icon = require("astroui").get_icon("FileNew", 0, true),
              desc = "New File  ",
            },
            {
              key = "f",
              action = "<Leader>ff",
              icon = require("astroui").get_icon("Search", 0, true),
              desc = "Find File  ",
            },
            {
              key = "o",
              action = "<Leader>fo",
              icon = require("astroui").get_icon("DefaultFile", 0, true),
              desc = "Recents  ",
            },
            {
              key = "w",
              action = "<Leader>fw",
              icon = require("astroui").get_icon("WordFile", 0, true),
              desc = "Find Word  ",
            },
            {
              key = "'",
              action = "<Leader>f'",
              icon = require("astroui").get_icon("Bookmarks", 0, true),
              desc = "Bookmarks  ",
            },
            {
              key = "s",
